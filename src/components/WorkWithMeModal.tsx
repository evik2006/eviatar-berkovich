...
const INSTAGRAM_URL = 'https://www.instagram.com/eviatar_2006/';
      ...
      >
        ...
        <div style={{ display: 'flex', gap: '12px', justifyContent: 'center' }}>
          ...
          >
            ...
            <span style={{ fontFamily: 'var(--font-heading)', fontSize: '9px', fontWeight: 400, letterSpacing: '0.12em', color: '#FFFFFF', textTransform: 'uppercase' }}>
              WhatsApp
            </span>
          </a>
          ...
          <a
            ...
            onMouseLeave={(e) => { (e.currentTarget as HTMLElement).style.borderColor = 'rgba(255,255,255,0.15)'; (e.currentTarget as HTMLElement).style.background = 'transparent'; }}
          >
            <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#FFFFFF" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round">
